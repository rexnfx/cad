...
rect = Rectangle(width = 17.1 + 45.8 + 4.5 + 1.4 + 12.5 + 8,
                 height=26.5 + 8,
...
line = Polyline([
    ...
    (17.1, 0), 
    (17.1 + 45.8, 0),
    (17.1 + 45.8, (26.5-19.5)/2),
    (17.1 + 45.8 + 4.5,(26.5-19.5)/2),
    (17.1 + 45.8 + 4.5,(26.5-21.7)/2),
    (17.1 + 45.8 + 4.5 + 1.4,(26.5-21.7)/2),
    (17.1 + 45.8 + 4.5 + 1.4 + 12.5,(26.5-18.4)/2),
    (17.1 + 45.8 + 4.5 + 1.4 + 12.5, 26.5/2)
    ], close=False)
